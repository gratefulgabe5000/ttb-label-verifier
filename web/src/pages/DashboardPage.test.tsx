...
import { ApiError, applicationsApi, batchApi, settingsApi } from "@/lib/api-client";
...
const APPLICATIONS: Application[] = [
  ...
  },
  {
    ...BASE_APPLICATION,
    id: 2,
    applicant_name: "Acme Beverage Co",
    serial_number: "25304001000456",
    ttb_id: "24308001000002",
  },
];
...
describe("DashboardPage", () => {
  ...
  it("renders the application list (12.1) and upload action (12.7)", async () => {
    ...
    expect(await screen.findByText("24308001000001")).toBeInTheDocument();
    expect(screen.getByText("24308001000002")).toBeInTheDocument();
  ...
  it("filters across all columns by any matching value (12.2)", async () => {
    renderDashboard();
    await screen.findByText("24308001000001");
    expect(screen.getByText("24308001000002")).toBeInTheDocument();
    ...
    expect(screen.queryByText("24308001000002")).not.toBeInTheDocument();
  });
